...
alias porty="sudo lsof -iTCP -sTCP:LISTEN -n -P"
alias dce="docker-compose exec"
alias dc="docker-compose"
alias dceu=docker-compose-exec-user
alias drush-sex=drush-cex
...
docker-compose-exec-user() {
  docker-compose exec $1 --user "$(id -u):$(id -g)" $@:2
}

drush-cex() {
 echo -e "\xF1\x9f\x8D\x86 OH BABY \xF0\x9F\x92\xA6"
 drush cex
}
#
